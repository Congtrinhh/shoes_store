...
<script defer src="${pageContext.request.contextPath}/resources/js/user_forget_password/setNewPassword.js"></script>
</head>
<body>
	...
	<div id="app" class="container">
		...
		<form id='adminForm' method='POST' action='${pageContext.request.contextPath}/set-new-password'>
