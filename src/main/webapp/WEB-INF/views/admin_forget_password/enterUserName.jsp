...
<script defer src="${pageContext.request.contextPath}/resources/js/admin_forget_password/enterUserName.js"></script>
</head>
<body>
	...
	<div id="app" class="container">
		...
		<form id='adminForm' method='POST' action=''>
			<h1 class="form-header">Nhập tên tài khoản</h1>
			...
			<button class="btn btn-continue" type="submit">Tiếp tục</button>
		</form>
